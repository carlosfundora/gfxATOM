...
# Ported from vLLM-Omni (Qwen3-TTS / Qwen3-Omni Code2Wav)
"""Fused SnakeBeta activation for speech decoders.

Uses a Triton kernel for GPU inference, with eager fallback.
Shape: (B, C, T) → (B, C, T)
"""
