...
# Ported from: vllm-omni/vllm_omni/model_executor/models/common/snake_activation.py
# Original Copyright 2025 The Qwen team.
"""Shared SnakeBeta activation for speech decoders (Qwen3-TTS, Qwen3-Omni Code2Wav).

SnakeBeta := x + 1/b * sin²(x*a)

Reference: Liu Ziyin, Tilman Hartwig, Masahito Ueda (2006.08195)
"""
